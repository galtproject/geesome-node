...
- Integrate ActivityPub/Fediverse so GeeSome groups and posts can federate with compatible servers; the current MVP has public actor/outbox/post/follow routes, signed inbound follow acceptance, outbound follow-accept delivery, and local post ActivityPub object records, with shared-inbox object routing still to finish.
