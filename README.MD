...
- Finish the existing Pinata/pinning path: manual API/UI, user-account automation, and an explicit public group-post backend policy exist; add group settings controls for post-manifest/content target selection.
