...
See [Docker image publication and deployment](docs/docker-images.md) for registry login, SHA-tag publication, release aliases, CI, platform support and rollback.
