...
- Finish the existing Pinata/pinning path: manual API/UI and opt-in user-account automatic pinning controls exist; define a separate group/post auto-pin ownership policy before enabling group accounts.
