...
- Add a global storage space analyzer UI for file-catalog and group usage, with drilldowns into largest files, file types, duplicate/shared storage IDs, and safe cleanup blockers.
