...
- Simple remote social-page migration can import a user's public Bluesky or ActivityPub presence into a GeeSome personal group, preserve replies/reposts/quotes, create remote placeholders for referenced groups/accounts, and reconcile those placeholders when they later migrate. Native Bluesky imported-post reply/quote reconciliation is covered for already-imported group posts, and ActivityPub imported-post reply/quote reconciliation is covered for already-created visible remote posts. Remaining migration work is the UI wizard and signed/non-admin ActivityPub ownership proof.
