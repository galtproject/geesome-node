...
module.exports = {
  ...
  renderConfig: {},
  modules: process.env.MODULES ? process.env.MODULES.split(',') : ['asyncOperation', 'group', 'groupCategory', 'fileCatalog', 'invite', 'telegramClient', 'staticSiteGenerator', 'rss', 'ethereumAuthorization']
};
