...
module.exports = async (app: IGeesomeApp) => {
        ...
        await app.updateGroup(userId, myBlogGroup.id, {avatarImageId: avatar1ImageContent.id, coverImageId: cover1ImageContent.id});
        ...
        await app.updateGroup(userId, favoritesGroup.id, {avatarImageId: avatar2ImageContent.id, coverImageId: cover2ImageContent.id});
        ...
        await app.updateGroup(testUser.id, testGroup.id, {avatarImageId: avatar3ImageContent.id, coverImageId: cover3ImageContent.id});
