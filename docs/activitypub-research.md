...
- Handle `Flag`. Status: signed group-inbox `Flag` activities for the local actor or known local objects are stored as pending reports and exposed through a read-only AdminRead list route; moderation UI/actions remain future work.
