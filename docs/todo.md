...
- Add actor, outbox, inbox, followers, and following endpoints. Read-only actor, outbox, followers, following, and post-object routes are exposed; following lists accepted outbound follows after a remote accept is recorded.
