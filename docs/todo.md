...
- Add actor, outbox, inbox, followers, and following endpoints. Read-only actor, outbox, followers, and post-object routes are exposed; following and background remote-delivery worker wiring are still future slices.
