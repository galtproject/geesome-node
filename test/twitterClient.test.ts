...
describe.only("twitterClient", function () {
	...
	//{"author_id":"3142378517","created_at":"2021-05-21T22:39:35.000Z","possibly_sensitive":false,"lang":"en","source":"Twitter for Android","entities":{"mentions":[{"start":0,"end":14,"username":"sparkpool_eth","id":"955345726858452992"}]},"referenced_tweets":[{"type":"replied_to","id":"1395662836840288261"}],"reply_settings":"everyone","in_reply_to_user_id":"955345726858452992","conversation_id":"1395662646951641090","text":"@sparkpool_eth Can you please share the link of this page?","id":"1395871923561803781"}
	...
	const includes = {
		"tweets": [
			...
			"context_annotations": [{
				...
				}, "entity": {"id": "847888632711061504", "name": "Personal finance", "description": "Personal finance"}
			}, {
				"domain": {
					"id": "30",
					"name": "Entities [Entity Service]",
	...
	it('webpage message should import properly', async () => {
		...
		const {file, fileSize, mimeType, thumbSize} = twitterHelpers.getMediaFileAndSize(message.media);
